        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sticky top-6">
            ...
            >
              ...
              <button 
                className="w-full py-3 px-4 rounded-full font-bold shadow-lg"
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF5500]"
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <input
                        ...
                        value={formData.primary_color}
                        onChange={(e) => setFormData({...formData, primary_color: e.target.value})}
                        className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF5500] font-mono"
                        placeholder="#FF5500"
                      />
                    </div>
                    <p className="text-xs text-[#71717A] mt-1">
