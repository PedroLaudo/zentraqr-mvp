...
const ClassicTemplate = ({ menuData, onAddToCart, brandPrimary, brandSecondary }) => {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          {menuData.sections.map((section) => (
            <div key={section.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 border border-gray-200 dark:border-gray-700">
